...
Anthropic Claude uses a different API format and requires a separate implementation.
"""
...
class ClaudeClient(BaseLLMClient):
    ...
    def _build_request_body(
        ...
        **kwargs
        ...
        Claude's system prompt is a separate field, not included in messages
        """
        ...
        # Claude does not support temperature=0, minimum is 0.1
